...
async def get_me_button(user):
    ...
    try:
        buttons = [
            [
                InlineKeyboardButton("Hᴇᴀᴅᴇʀ Txᴛ", callback_data="ident"),
                InlineKeyboardButton(
                    "❌ ᴏғғ" if user["is_header_text"] else "✅ ᴏɴ",
                    callback_data=f'setgs#is_header_text#{not user["is_header_text"]}#{str(user_id)}',
                ),
            ],
            [
                InlineKeyboardButton("Fᴏᴏᴛᴇʀ Txᴛ", callback_data="ident"),
                InlineKeyboardButton(
                    "❌ Oғғ" if user["is_footer_text"] else "✅ ᴏɴ",
                    callback_data=f'setgs#is_footer_text#{not user["is_footer_text"]}#{str(user_id)}',
                ),
            ],
            [
                InlineKeyboardButton("Usᴇʀɴᴀᴍᴇ", callback_data="ident"),
                InlineKeyboardButton(
                    "❌ Oғғ" if user["is_username"] else "✅ ᴏɴ",
                    callback_data=f'setgs#is_username#{not user["is_username"]}#{str(user_id)}',
                ),
            ],
            [
                InlineKeyboardButton("Bᴀɴɴᴇʀ Iᴍᴀɢᴇ", callback_data="ident"),
                InlineKeyboardButton(
                    "❌ Oғғ" if user["is_banner_image"] else "✅ ᴏɴ",
...
async def set_commands(app):
    COMMANDS = [
        BotCommand("start", "ᴛᴏ ᴄʜᴇᴄᴋ ʙᴏᴛ ᴀʟɪᴠᴇ ᴏʀ ɴᴏᴛ"),
        BotCommand("help", "ᴛᴏ ɢᴇᴛ ʜᴇʟᴘ ᴀʙᴏᴜᴛ ʙᴏᴛ"),
        BotCommand("about", "ᴛᴏ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ ʙᴏᴛ"),
        BotCommand("api", "ᴛᴏ sᴇᴛ Dalink.in API"),
        BotCommand("balance", "ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴅᴇᴛᴀɪʟ ᴀᴄᴄᴏᴜɴᴛ ʙᴀʟᴀɴᴄᴇ"),
        BotCommand("account", "ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴀᴄᴄᴏᴜɴᴛ ɪɴғᴏ"),
        BotCommand("method", "ᴛᴏ sᴇᴛ/ᴄʜᴀɴɢᴇ ʏᴏᴜʀ ᴍᴇᴛʜᴏᴅ"),
        BotCommand("mdisk_api", "ᴛᴏ sᴇᴛ ᴍᴅɪsᴋ API."),
        BotCommand("header", "ᴛᴏ sᴇᴛ ᴛʜᴇ ʜᴇᴀᴅᴇʀ."),
        BotCommand("footer", "ᴛᴏ sᴇᴛ ᴛʜᴇ ғᴏᴏᴛᴇʀ."),
        BotCommand("username", "ᴛᴏ sᴇᴛ ᴛʜᴇ ᴜsᴇʀɴᴀᴍᴇ ᴛᴏ ʀᴇᴘʟᴀᴄᴇ"),
        BotCommand("banner_image", "ᴛᴏ sᴇᴛ ᴛᴛʜᴇ ʙᴀɴɴᴇʀ ɪᴍᴀɢᴇ."),
        BotCommand("settings", "ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ sᴇᴛᴛɪɴɢs"),
        BotCommand("include_domain", "ғᴏʀ ᴀᴅᴅɪɴɢ ɪɴᴄʟᴜᴅᴇᴅ ᴅᴏᴍᴀɪɴ."),
        BotCommand("exclude_domain", "ғᴏʀ ᴀᴅᴅɪɴɢ ᴇxᴄʟᴜᴅᴇᴅ ᴅᴏᴍᴀɪɴ."),
    ]
